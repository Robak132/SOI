...
_PROTOTYPE (int (*call_vec[NCALLS]), (void) ) = {
	...
	do_reboot,	/* 76 = reboot	*/
	do_svrctl,	/* 77 = svrctl	*/
	set_group,	/* 78 = set_group	*/
	get_group,	/* 79 = get_group	*/
	set_schedule_a,	/* 80 = set_schedule_a	*/
	set_schedule_b,	/* 81 = set_schedule_b	*/
	get_time,	/* 82 = get_time	*/
	do_hole_map,	/* 83 = hole_map */
	do_worst_fit,	/* 84 = worst_fit */
};
