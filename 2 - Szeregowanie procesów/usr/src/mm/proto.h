...
_PROTOTYPE( int set_group, (void)						);
_PROTOTYPE( int get_group, (void)						);
_PROTOTYPE( int set_schedule_a, (void)						);
_PROTOTYPE( int set_schedule_b, (void)						);
_PROTOTYPE( int get_time, (void)						);
